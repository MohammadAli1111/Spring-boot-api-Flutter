...
class EditEmployeeApp extends StatefulWidget{
...
class EditEmployee extends State<EditEmployeeApp> {
  static const route="/editEmployee";
  ...
  Widget build(BuildContext context) {
    if(employee==null) {
      var jsonMap = ModalRoute
          .of(context)
          .settings
          .arguments;
      employee = Employee.fromJson(jsonMap);
    }
    return MaterialApp(
